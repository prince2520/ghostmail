                    ...
                    <Tooltip>
                        <TooltipTrigger>
                            <button disabled={!mailDetail?.address} onClick={() => {
                                ...
                                navigator.clipboard.writeText(mailDetail?.address)} }className="border border-neutral-300 dark:border-0 text-zinc-800 cursor-pointer px-2 py-2 flex items-center justify-center bg-white rounded-full">
                                <Copy size={18} />
                            </button>
                        </TooltipTrigger>
                        <TooltipContent>
